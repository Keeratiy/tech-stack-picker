...
export function SelectedStack({
  ...
  return (
    <section
      className="border border-rule bg-white/60"
    ...
    >
      ...
      {selectedCount === 0 ? (
        ...
        <div className="p-4">
                    ...
                    <section key={category.id}>
                      ...
                      <ul className="mt-1.5 space-y-1.5">
                        {technologies.map((technology) => (
                          <li
                            key={technology.id}
                            className="flex items-start gap-2 border-l-2 border-coral bg-paper px-2 py-2 text-xs leading-4 transition-opacity duration-200"
                          >
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="grid size-6 shrink-0 place-items-center border border-rule text-muted transition-colors hover:border-ink hover:text-ink focus-visible:ring-2 focus-visible:ring-coral/30"
                            ...
                            <span className="shrink-0 border border-rule px-1 py-0.5 text-[8px] font-semibold uppercase tracking-[0.1em] text-muted">
                              {domain}
                            </span>
                          </li>
                        ))}
          ...
          <p className="border-t border-rule pt-3 text-[10px] uppercase tracking-[0.12em] text-muted">
